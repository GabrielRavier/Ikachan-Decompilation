...
char aGbgcgugGkgeb_0[27] = "メインボリューム（ドラム）"; // weak
_UNKNOWN unk_412F6C; // weak
_UNKNOWN unk_412F80; // weak
char aGbgcgugGkgebGa[29] = "メインボリューム（メロディ）"; // weak
char aGGkgebGaokvV[17] = "ボリュームOKです"; // weak
char aGtgfbGhbighgig[19] = "フェード（ドラム）"; // weak
char aGtgfbGhbigbgng[21] = "フェード（メロディ）"; // weak
...
CHAR aGGkgebGarTsv[15] = "ボリューム設定"; // idb
